-- Kapsula turlari va mahsulotlarini qo'shish (stikersiz)

-- 1. ProductType (Mahsulot turlari)
INSERT INTO ProductType (id, name, description, defaultCard, active, createdAt, updatedAt) VALUES
...
('kapsula-75-siniy1', 'Kapsula 75 gr синий', 'LARGE', 25, 12, 50, 125, 25, 750, 2.22, 1.42, false, true, 'kapsula-type', 'kapsula-75gr', 'size-75gr', datetime('now'), datetime('now')),
('kapsula-75-siniy2', 'Kapsula 75 gr синий', 'LARGE', 25, 12, 50, 125, 25, 750, 2.22, 1.42, false, true, 'kapsula-type', 'kapsula-75gr', 'size-75gr', datetime('now'), datetime('now')),
...
('kapsula-80-gidro1', 'Kapsula 80 gr гидро', 'LARGE', 20, 10, 40, 100, 20, 400, 2.55, 1.65, false, true, 'kapsula-type', 'kapsula-80gr', 'size-80gr', datetime('now'), datetime('now')),
('kapsula-80-gidro2', 'Kapsula 80 gr гидро', 'LARGE', 20, 10, 40, 100, 20, 400, 2.55, 1.65, false, true, 'kapsula-type', 'kapsula-80gr', 'size-80gr', datetime('now'), datetime('now')),
('kapsula-80-sayxun1', 'Kapsula 80 gr сайхун', 'LARGE', 20, 10, 40, 100, 20, 400, 2.60, 1.70, false, true, 'kapsula-type', 'kapsula-80gr', 'size-80gr', datetime('now'), datetime('now')),
('kapsula-80-sayxun2', 'Kapsula 80 gr сайхун', 'LARGE', 20, 10, 40, 100, 20, 400, 2.60, 1.70, false, true, 'kapsula-type', 'kapsula-80gr', 'size-80gr', datetime('now'), datetime('now')),
('kapsula-80-siniy1', 'Kapsula 80 gr синий', 'LARGE', 20, 10, 40, 100, 20, 400, 2.52, 1.62, false, true, 'kapsula-type', 'kapsula-80gr', 'size-80gr', datetime('now'), datetime('now')),
('kapsula-80-siniy2', 'Kapsula 80 gr синий', 'LARGE', 20, 10, 40, 100, 20, 400, 2.52, 1.62, false, true, 'kapsula-type', 'kapsula-80gr', 'size-80gr', datetime('now'), datetime('now')),

-- 85 gramm - 2 ta mahsulot
('kapsula-85-prozraya1', 'Kapsula 85 gr прозрая', 'LARGE', 18, 9, 36, 90, 18, 324, 2.80, 1.80, false, true, 'kapsula-type', 'kapsula-85gr', 'size-85gr', datetime('now'), datetime('now')),
('kapsula-85-prozraya2', 'Kapsula 85 gr прозрая', 'LARGE', 18, 9, 36, 90, 18, 324, 2.80, 1.80, false, true, 'kapsula-type', 'kapsula-85gr', 'size-85gr', datetime('now'), datetime('now')),

-- 86 gramm - 2 ta mahsulot
('kapsula-86-prozraya1', 'Kapsula 86 gr прозрая', 'LARGE', 18, 9, 36, 90, 18, 324, 2.85, 1.85, false, true, 'kapsula-type', 'kapsula-86gr', 'size-86gr', datetime('now'), datetime('now')),
('kapsula-86-prozraya2', 'Kapsula 86 gr прозрая', 'LARGE', 18, 9, 36, 90, 18, 324, 2.85, 1.85, false, true, 'kapsula-type', 'kapsula-86gr', 'size-86gr', datetime('now'), datetime('now')),

-- 135 gramm - 8 ta mahsulot
('kapsula-135-prozraya1', 'Kapsula 135 gr прозрая', 'LARGE', 10, 5, 20, 50, 10, 100, 4.50, 2.90, false, true, 'kapsula-type', 'kapsula-135gr', 'size-135gr', datetime('now'), datetime('now')),
('kapsula-135-prozraya2', 'Kapsula 135 gr прозрая', 'LARGE', 10, 5, 20, 50, 10, 100, 4.50, 2.90, false, true, 'kapsula-type', 'kapsula-135gr', 'size-135gr', datetime('now'), datetime('now')),
('kapsula-135-gidro1', 'Kapsula 135 gr гидро', 'LARGE', 10, 5, 20, 50, 10, 100, 4.60, 3.00, false, true, 'kapsula-type', 'kapsula-135gr', 'size-135gr', datetime('now'), datetime('now')),
('kapsula-135-gidro2', 'Kapsula 135 gr гидро', 'LARGE', 10, 5, 20, 50, 10, 100, 4.60, 3.00, false, true, 'kapsula-type', 'kapsula-135gr', 'size-135gr', datetime('now'), datetime('now')),
...
('kapsula-135-siniy1', 'Kapsula 135 gr синий', 'LARGE', 10, 5, 20, 50, 10, 100, 4.55, 2.95, false, true, 'kapsula-type', 'kapsula-135gr', 'size-135gr', datetime('now'), datetime('now')),
('kapsula-135-siniy2', 'Kapsula 135 gr синий', 'LARGE', 10, 5, 20, 50, 10, 100, 4.55, 2.95, false, true, 'kapsula-type', 'kapsula-135gr', 'size-135gr', datetime('now'), datetime('now')),
