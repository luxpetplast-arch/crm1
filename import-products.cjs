    ...
    try {
        ...
        products.forEach((product, index) => {
            try {
                ...
                const query = `INSERT INTO [Product] (id, name, bagType, unitsPerBag, minStockLimit, optimalStock, maxCapacity, currentStock, currentUnits, pricePerBag, productionCost, createdAt, updatedAt) VALUES ('${id}', '${product.name}', '${product.bagType}', ${product.unitsPerBag}, 50, 500, 0, 0, ${product.price}, 0, datetime('now'), datetime('now'));`;
